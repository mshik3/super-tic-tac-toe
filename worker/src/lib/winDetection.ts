import type { Cell, SubBoard, MainBoard } from '../types/messages';
 ...
 */
export function getValidMoves(subBoards: SubBoard[], activeBoard: number | null): Array<{ boardIndex: number; cellIndex: number }> {
